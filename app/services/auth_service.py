...
class AuthService:
    ...
    def create_access_token(
        ...
        try:
            encoded_jwt = jwt.encode(to_encode, get_settings().SECRET_KEY, algorithm=self.algorithm)
            return encoded_jwt
    ...
    def verify_token(self, token: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            payload = jwt.decode(token, get_settings().SECRET_KEY, algorithms=[self.algorithm])
            return payload
